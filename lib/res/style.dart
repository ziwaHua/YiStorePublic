...
class Styles {
  ...
  TextStyle(color: YiColors.color_1A2F51, fontSize: 14.sp);
  static TextStyle style_1A2F51_16 =
  TextStyle(color: YiColors.color_1A2F51, fontSize: 16.sp);
  static TextStyle style_1A2F51_18 =
  TextStyle(color: YiColors.color_1A2F51, fontSize: 18.sp);

  ///---------------------------淡灰色字体区域-------------------------------
  static TextStyle style_B8C0D4_11 =
  TextStyle(color: YiColors.color_B8C0D4, fontSize: 11.sp);
  static TextStyle style_B8C0D4_13 =
  TextStyle(color: YiColors.color_B8C0D4, fontSize: 13.sp);
  static TextStyle style_B8C0D4_14 =
  TextStyle(color: YiColors.color_B8C0D4, fontSize: 14.sp);
  ...
  TextStyle(color: YiColors.color_6A6969, fontSize: 14.sp);
  static TextStyle style_6A6969_16 =
  TextStyle(color: YiColors.color_6A6969, fontSize: 16.sp);
  static TextStyle style_6A6969_28 =
  TextStyle(color: YiColors.color_6A6969, fontSize: 28.sp);
  static TextStyle style_000000_30 =
  TextStyle(color: YiColors.color_000000, fontSize: 30.sp);
  ...
  TextStyle(color: YiColors.color_24CF5F, fontSize: 14);

  ///---------------------------黄色、淡黄色字体区域-------------------------------
  static TextStyle style_FE8C28_24_bold = TextStyle(
      color: YiColors.color_FE8C28,
      fontSize: 24.sp,
      fontWeight: FontWeight.w700);

  static TextStyle style_FFAE2E_14 =
  TextStyle(color: YiColors.color_FFAE2E, fontSize: 14.sp);

  static TextStyle style_FFAE2E_16 =
  TextStyle(color: YiColors.color_FFAE2E, fontSize: 16.sp);

  static TextStyle style_FE8C28_11 = TextStyle(
      color: YiColors.color_FE8C28, fontSize: 11.sp, height: 1.1.sh);
}
