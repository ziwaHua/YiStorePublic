...
import 'package:yistore/res/style.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "暂无数据",
                style:
                TextStyle(fontSize: 32.sp, color: YiColors.color_999999),
              ),
              Box.hBox20,
              Text(
                "点我重试",
                style:
                TextStyle(fontSize: 25.sp, color: YiColors.color_999999),
              )
            ],
          ),
        )),
...
AppBar createAppBar(
  ...
  return AppBar(
    ...
    centerTitle: true,
    backgroundColor: YiColors.color_EA4C43,
    iconTheme: const IconThemeData(color: YiColors.color_white),
    elevation: 0,
...
SystemUiOverlayStyle systemOverLayoutStyle() {
  return const SystemUiOverlayStyle(
      ...
      systemNavigationBarColor: YiColors.color_EA4C43,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  error ?? "页面加载异常",
                  style: TextStyle(
                      fontSize: 32.sp, color: YiColors.color_999999),
                ),
                Box.hBox20,
                Text(
                  "点我重试",
                  style: TextStyle(
                      fontSize: 25.sp, color: YiColors.color_999999),
                )
              ],
            ),
          )));
